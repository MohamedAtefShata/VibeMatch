...
Route::middleware(['auth'])->group(function () {
    Route::prefix('songs')->name('songs.')->group(function () {
        ...
        Route::get('/recommendations/page', [SongController::class, 'recommendationPage'])
            ->name('recommendation-page');
    });
});

Route::prefix('api')->group(function () {
    // Song-related API endpoints - using Inertia
    Route::prefix('songs')->name('api.songs.')->group(function () {
        ...
        Route::middleware(['auth'])->group(function () {
            Route::get('/personalized', [RecommendationController::class, 'personalizedRecommendations'])
                ->name('personalized');
            Route::get('/previous-recommendations', [SongController::class, 'previousRecommendations'])
